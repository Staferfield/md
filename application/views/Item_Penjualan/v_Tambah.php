                    ...
                    <form id="formTambah" action="<?php echo site_url('Item_Penitipan/addAction/' . $nota['id']); ?>" method="post">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="jml_laku" placeholder="Jumlah Laku" value="<?php ?>" min="0" required="required" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="harga">Harga:</label>
                                <input class="form-control" type="number" name="harga" placeholder="Harga" value="<?php ?>" min="0" required="required" />
                            </div>
                        </div>
