                    ...
                    <tbody class="text-center">
                        ...
                        foreach ($penjualan as $item) { ?>
                            <tr>
                                ...
                                <td><a class="label label-success" href="<?php echo site_url('Item_Penitipan/byNotaID/'.$item['titip_id']); ?>"><?php echo $item['titip_id']; ?></a></td>
                                <td><a class="btn btn-sm btn-info" href="<?php echo site_url('Item_Penjualan/byNotaID/' . $item['id']); ?>">Lihat Item</a></td>
                                <td>
                                    <div class="btn-group">
